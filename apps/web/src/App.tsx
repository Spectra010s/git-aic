          ...
          <section className="px-4 py-16 md:px-8 grid gap-8 md:grid-cols-[1fr_0.8fr]">
            <article className="space-y-4">
              ...
              <p className="text-ink-muted leading-relaxed max-w-[50ch]">
                Your brain is for building code, not for summarizing it. Git-AIC automates the
                friction of the commit stage, proposing perfectly formatted messages so you can stay
                in your flow.
              </p>
            </article>
