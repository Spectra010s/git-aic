  ...
  return (
    <footer className="px-4 py-8 md:px-8 flex flex-wrap items-center justify-between gap-x-8 gap-y-4 text-sm text-ink-muted border-t border-line mt-16">
      <p>
        Built by{' '}
        <a
          href="https://spectra010s.biuld.app"
          target="_blank"
          rel="noreferrer"
          className="text-ink hover:underline transition-all"
        >
          Spectra010s
        </a>
        .
      ...
      <nav aria-label="Footer" className="flex gap-8">
        <a
          className="text-ink no-underline hover:text-ink-muted transition-colors font-medium"
          href="/docs"
        >
          Documentation
        </a>
